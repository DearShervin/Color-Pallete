  ...
  lockBtn.forEach((btn, index) => {
    btn.addEventListener("click", () => {
      ...
      if (colorDivs[index].classList.contains('locked')) {
        btn.firstElementChild.classList.replace("fa-lock-open", "fa-lock");
      } else {
        btn.firstElementChild.classList.replace("fa-lock", "fa-lock-open");
      }
    });
  });
//FUNCTIONS :
...
//Color Generator with chroma.js :
  ...
  function hslControls(e) {
    ...
    colorDivs[index].style.backgroundColor = chroma(bgColor)
